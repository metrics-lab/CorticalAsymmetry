...
msm --inmesh=/data/HCP/${Subject}/T1w/Native/100206.${Hemisphere}.sphere.rot.native.surf.gii \
    --refmesh=/data/CorticalAsymmetry/Templates/HCP-YA/${Hemisphere}.sphere.32k_fs_LR.surf.gii \
    --indata=/data/HCP/${Subject}/T1w/Native/100206.${Hemisphere}.sulc.native.shape.gii \ 
    ...
    -o /data/CorticalAsymmetry/HCPAsymmetry/${Subject}/T1w/Native/100206.L.MSMstrain. 
